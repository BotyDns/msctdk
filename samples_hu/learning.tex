...
A nagy adathalmaz miatt a Random Forest modell is nagyon nagy lesz (körülbelül 16GB), ami egy nehezen kezelhető méret, így érdemes módosítani a modell paraméterein, hogy ez kisebb méretű legyen. A legjobb eredményeket a Random Forest fák mélységének a limitálásával értünk el, ahol látható volt, hogy
