...
\todo[inline,color=blue!50]{Furcsán mutat az, hogy "\cite{sakti2023} Sentinel-2 műholdfelvételeken tanítottak be \ldots". Ilyenkor kiírjuk a szerző(k) nevét, és a mondatban később hivatkozzuk számmal a cikket. Ezt átírtam ennek megfelelően, a többit is így kéne, a teljes dolgozatban!}
...
\begin{figure}[H]
    ...
    \label{fig:sakti}
\end{figure}\todo[color=blue!50]{Érdemes ellenőrizni, nem túl kicsi-e a képen a szöveg.}
