...
A kutatás során felhasználom a kutatólaborban már számolt indexeket. Pontosabban a Plastic Index (PI), Normalized Difference Water Index (NDWI), Normalized Difference Vegetation Index (NDVI), Reversed Normalized Difference Vegetation Index (RNDVI), Simple Ratio (SR) indexek kerülnek használatra \todo{Jó referencia ezekhez az indexekhez}.