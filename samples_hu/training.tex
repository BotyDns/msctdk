...
\begin{figure}[H]
  ...
  \subcaptionbox{A klasszifikálandó felvétel.}{
	...
	\hspace{5pt}
	\subcaptionbox{A teljes méretű modell.}{
		\includegraphics[width=0.45\linewidth]{fullsized}}
	\hspace{5pt}
	\subcaptionbox{A csökkentett modell.}{
		\includegraphics[width=0.45\linewidth]{reduced}}
	\caption{A csökkentett modell keveseb \textit{true positive} értéket termel a teljes méretű modellhez képest a pusztazámori hulladéklerakó egyik felvételén. Felvétel dátuma: 2021.12.08.}
